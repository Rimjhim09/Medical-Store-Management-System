...
def open_win():
    ...
    apt = Tk()
    apt.title("Interface")
    Label(apt, text="SY-ET-A Batch 2 Pharmacy").grid(row=0, column=0, columnspan=3)
    Label(apt, text='*' * 80).grid(row=1, column=0, columnspan=3)
    Label(apt, text='-' * 80).grid(row=3, column=0, columnspan=3)

    Label(apt, text="Stock Supply", bg='green', fg='white').grid(row=2, column=0)
    Button(apt, text='Registered Client', width=25, bg='green', fg='white', command=val_cus).grid(row=4, column=0)
    ...
    Label(apt, text="View Database", bg='blue', fg='white').grid(row=2, column=1)
    ...
    Button(apt, text='Check Expiry', bg='red', fg='white', width=15, command=exp_date).grid(row=6, column=1)
...
def again():
    ...
    root.title('SY-ET-A Batch 2 OOP CP')
    Label(root, text='"SY-ET-A Batch 2 Pharmacy"').grid(row=0, column=0, columnspan=5)
    Label(root, text="VIT Pune").grid(row=1, column=0, columnspan=5)
...
def open_cus():
    ...
    apt = Tk()
    apt.title("Interface")
    Label(apt, text="*** SY-ET-A Batch 2 Pharmacy ***", bg='blue', fg='white').grid(row=0, column=0)
    Label(apt, text='*' * 40).grid(row=1, column=0)
    Label(apt, text='*  Welcome!  *', bg='green', fg='white').grid(row=2, column=0)
